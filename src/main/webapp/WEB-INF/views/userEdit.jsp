...
<jsp:include page="header.jsp"></jsp:include>
	...
	<div class ="jumbotron">
		...
		<div>
			<form:form modelAttribute = "registerUser" action = "edit" method = "post">
				<table class ="table table-striped">
					<tr>
						<td><form:label path="username" for="username">User Name:</form:label></td>
						<td>
						${registerUser.username }
						<form:input path="username" type = "hidden" value = "${registerUser.username }"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td><form:label for="phone" path="phone" cssErrorClass="phone">Phone:</form:label></td>
